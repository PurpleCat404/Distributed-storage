...
def main():
    ...
    all_values_parser = subparsers.add_parser('all_values',
                                              help='Посмотреть все значения')

    parser.add_argument('--base-url',
                        default='http://localhost:8000',
                        help='Базовый URL главного сервера')
